...
def build_generation_prompt(
    ...
    parts = [
        ...
        "3) Read from standard input and write to standard output directly when the problem asks for it.",
        "4) The code must handle the full input constraints efficiently.",
        "5) Avoid direct numeric computation that can overflow when the task only requires comparison.",
        "6) Do NOT output any reasoning or prediction tags in this stage.",
        GENERATION_FEWSHOT,
        "Question:",
